  ...
  return (
      <div onClick={onButtonClick} className={styles.summaryContainer}>
        ...
        <div className={styles.summaryExtra}>
          <div className={styles.cheesePrice}><span><strong>Price per kilo ($):</strong> </span><span>{price}</span></div>
          <div className={styles.cheeseColour}><span><strong>Colour: </strong></span><span>{colour}</span></div>
        </div>
